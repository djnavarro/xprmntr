...
#' Define a free text response question
#'
#' @param prompt The question
#' @param placeholder The placeholder text in the response field (default = "")
#' @param required Is this a required question (default = FALSE)
#' @param rows How many text rows should the response box use? (default = 1)
#' @param columns How many text columns should the response box use? (default = 40)
#' @param name A name for the question (if NULL, defaults to Q0, Q1, etc)
#'
#' @export
...
#'
#' @param questions A list of questions, each generated by question_multi()
#' @param randomize_question_order Should the question order be randomised? (default = FALSE)
#' @param preamble Text to display above the survey items
#' @param button_label Text displayed on button at the end (default = "Continue")
#'
...
#' Survey trial with free text responses
#'
#' @param questions A list of questions, each generated by question_text()
#' @param randomize_question_order Should the question order be randomised? (default = FALSE)
#' @param preamble Text to display above the survey items
#' @param button_label Text displayed on button at the end (default = "Continue")
#'
